...
;
	($.$giper_balls_crowd) = class $giper_balls_crowd extends ($.$giper_balls_game) {
		life(){
			return null;
		}
		title(){
    ...
    (function ($$) {
        class $giper_balls_crowd extends $.$giper_balls_crowd {
            ...
            life() {
                ...
                const kinds = [...init];
                const move = (from_row, from_col, to_row, to_col) => {
        ...
        __decorate([
            $mol_mem
        ], $giper_balls_crowd.prototype, "snapshot", null);
        __decorate([
            $mol_mem_key
        ], $giper_balls_crowd.prototype, "ball_kind", null);
        __decorate([
            $mol_mem_key
        ], $giper_balls_crowd.prototype, "ball_mood", null);
        __decorate([
            $mol_action
        ], $giper_balls_crowd.prototype, "ball_grab", null);
        __decorate([
            $mol_mem
        ], $giper_balls_crowd.prototype, "score", null);
        __decorate([
            $mol_mem
        ], $giper_balls_crowd.prototype, "score_text", null);
        __decorate([
            $mol_mem
        ], $giper_balls_crowd.prototype, "life", null);
        __decorate([
            $mol_action
        ], $giper_balls_crowd.prototype, "restart", null);
        $$.$giper_balls_crowd = $giper_balls_crowd;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$giper_balls_catalog) = class $giper_balls_catalog extends ($.$mol_book2_catalog) {
		...
		Crowd(){
			const obj = new this.$.$giper_balls_crowd();
			(obj.tools) = () => ([...(this.$.$giper_balls_crowd.prototype.tools.call(obj)), (this.Spread_close())]);
			return obj;
		}
		Chess(){
	...
	($mol_mem(($.$giper_balls_catalog.prototype), "Crowd"));
